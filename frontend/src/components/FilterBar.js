...
export default function FilterBar({ filters, filterOptions, onFilterChange, total, totalUnfiltered, showing, onSearchChange, hideInactive, onHideInactiveChange, hideUnverified, onHideUnverifiedChange }) {
